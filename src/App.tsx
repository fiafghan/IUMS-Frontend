    ...
    <>
      <Routes>
        ...
        <Route
          ...
          element={
            <PrivateRoute>
              <RoleChecker allowedRoles={["Admin", "User"]}>
                <InternetUserAddForm />
              </RoleChecker>
            </PrivateRoute>
          }
        ...
        <Route
          ...
          element={
            <RoleChecker allowedRoles={["Admin", "User"]}>
              <EmployeeViolationForm />
            </RoleChecker>
          }
        />
        <Route
          path="/addviolationonauser"
          element={
            <RoleChecker allowedRoles={["Admin", "User"]}>
              <AddViolationOnAUser />
            </RoleChecker>
        ...
        />
        <Route
          path="/all-violations-from-users"
          element={
            <PrivateRoute>
              <AllViolationsFromUsers />
            </PrivateRoute>
          }
        />
        <Route
